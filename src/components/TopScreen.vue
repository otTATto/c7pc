...
<template>
  <div class="flex min-h-screen flex-col items-center pb-16">
    ...
    <div class="mt-20 w-full max-w-3xl px-4">
      <div class="font-zen-kaku text-center font-bold text-gray-500">
        <p>
          <Star class="text-yello inline-block size-5 align-middle" />
    ...
    <div class="relative mt-10 w-full max-w-3xl px-4">
      ...
      <img
        :src="pressSpaceKey"
        width="300"
        alt="スペースキーでもスタートできます"
        class="pointer-events-none absolute top-0 right-0 -translate-y-[150%]"
      />
    </div>

    <footer class="fixed bottom-0 left-0 w-full pb-3">
      <p class="font-zen-maru text-center text-sm font-bold text-gray-500">
        © たと / メディアアートサークル C4's・2024 - 2025
      </p>
    </footer>
  </div>
</template>
